...
public class BaseItemAnim extends ItemAnimator {


	private static final boolean DEBUG = false;

	protected static final String TAG = "BaseItemAnim";
            ...
            Runnable mover = new Runnable() {
                ...
                public void run() {
                    for (MoveInfo moveInfo : moves) {
                    	Log.i(TAG, "runPendingAnimations, movesPending" + moves.toString());
